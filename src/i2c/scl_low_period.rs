...
pub struct SCL_LOW_PERIOD_R(crate::FieldReader<u16, u16>);
impl SCL_LOW_PERIOD_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        SCL_LOW_PERIOD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCL_LOW_PERIOD_R {
