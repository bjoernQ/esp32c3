...
pub struct WIFI_BB_CFG_2_R(crate::FieldReader<u32, u32>);
impl WIFI_BB_CFG_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        WIFI_BB_CFG_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WIFI_BB_CFG_2_R {
...
impl R {
    ...
    pub fn wifi_bb_cfg_2(&self) -> WIFI_BB_CFG_2_R {
        WIFI_BB_CFG_2_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - reg_wifi_bb_cfg_2"]
