...
pub struct FLASH_ACE1_SIZE_R(crate::FieldReader<u16, u16>);
impl FLASH_ACE1_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        FLASH_ACE1_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FLASH_ACE1_SIZE_R {
...
pub struct FLASH_ACE1_SIZE_W<'a> {
    w: &'a mut W,
}
impl<'a> FLASH_ACE1_SIZE_W<'a> {
...
impl W {
    #[doc = "Bits 0:12 - reg_flash_ace1_size"]
    #[inline(always)]
    pub fn flash_ace1_size(&mut self) -> FLASH_ACE1_SIZE_W {
        FLASH_ACE1_SIZE_W { w: self }
    }
