...
pub struct BACKUP_MEM_START_ADDR_R(crate::FieldReader<u32, u32>);
impl BACKUP_MEM_START_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BACKUP_MEM_START_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BACKUP_MEM_START_ADDR_R {
...
impl R {
    ...
    pub fn backup_mem_start_addr(&self) -> BACKUP_MEM_START_ADDR_R {
        BACKUP_MEM_START_ADDR_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - reg_backup_mem_start_addr"]
