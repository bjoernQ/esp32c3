...
pub struct FLASH_ACE0_SIZE_R(crate::FieldReader<u16, u16>);
impl FLASH_ACE0_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        FLASH_ACE0_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FLASH_ACE0_SIZE_R {
