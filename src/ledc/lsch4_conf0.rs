...
pub struct OVF_NUM_LSCH4_R(crate::FieldReader<u16, u16>);
...
pub struct OVF_CNT_EN_LSCH4_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn ovf_cnt_en_lsch4(&self) -> OVF_CNT_EN_LSCH4_R {
        OVF_CNT_EN_LSCH4_R::new(((self.bits >> 15) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - reg_timer_sel_lsch4."]
