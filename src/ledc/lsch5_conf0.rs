...
#[doc = "Field `TIMER_SEL_LSCH5` reader - reg_timer_sel_lsch5."]
...
#[doc = "Field `TIMER_SEL_LSCH5` writer - reg_timer_sel_lsch5."]
...
#[doc = "Field `SIG_OUT_EN_LSCH5` reader - reg_sig_out_en_lsch5."]
...
#[doc = "Field `SIG_OUT_EN_LSCH5` writer - reg_sig_out_en_lsch5."]
...
#[doc = "Field `IDLE_LV_LSCH5` reader - reg_idle_lv_lsch5."]
...
#[doc = "Field `IDLE_LV_LSCH5` writer - reg_idle_lv_lsch5."]
...
#[doc = "Field `PARA_UP_LSCH5` writer - reg_para_up_lsch5."]
...
#[doc = "Field `OVF_NUM_LSCH5` reader - reg_ovf_num_lsch5."]
pub struct OVF_NUM_LSCH5_R(crate::FieldReader<u16, u16>);
impl OVF_NUM_LSCH5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        OVF_NUM_LSCH5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OVF_NUM_LSCH5_R {
...
#[doc = "Field `OVF_NUM_LSCH5` writer - reg_ovf_num_lsch5."]
...
#[doc = "Field `OVF_CNT_EN_LSCH5` reader - reg_ovf_cnt_en_lsch5."]
pub struct OVF_CNT_EN_LSCH5_R(crate::FieldReader<bool, bool>);
impl OVF_CNT_EN_LSCH5_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OVF_CNT_EN_LSCH5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OVF_CNT_EN_LSCH5_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `OVF_CNT_EN_LSCH5` writer - reg_ovf_cnt_en_lsch5."]
...
#[doc = "Field `OVF_CNT_RESET_LSCH5` writer - reg_ovf_cnt_reset_lsch5."]
...
impl W {
    ...
    #[doc = "Bit 16 - reg_ovf_cnt_reset_lsch5."]
    #[inline(always)]
