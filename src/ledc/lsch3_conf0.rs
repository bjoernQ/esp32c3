...
#[doc = "Field `TIMER_SEL_LSCH3` reader - reg_timer_sel_lsch3."]
...
#[doc = "Field `TIMER_SEL_LSCH3` writer - reg_timer_sel_lsch3."]
...
#[doc = "Field `SIG_OUT_EN_LSCH3` reader - reg_sig_out_en_lsch3."]
...
#[doc = "Field `SIG_OUT_EN_LSCH3` writer - reg_sig_out_en_lsch3."]
...
#[doc = "Field `IDLE_LV_LSCH3` reader - reg_idle_lv_lsch3."]
...
#[doc = "Field `IDLE_LV_LSCH3` writer - reg_idle_lv_lsch3."]
...
#[doc = "Field `PARA_UP_LSCH3` writer - reg_para_up_lsch3."]
...
#[doc = "Field `OVF_NUM_LSCH3` reader - reg_ovf_num_lsch3."]
pub struct OVF_NUM_LSCH3_R(crate::FieldReader<u16, u16>);
impl OVF_NUM_LSCH3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        OVF_NUM_LSCH3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OVF_NUM_LSCH3_R {
...
#[doc = "Field `OVF_NUM_LSCH3` writer - reg_ovf_num_lsch3."]
pub struct OVF_NUM_LSCH3_W<'a> {
    w: &'a mut W,
}
impl<'a> OVF_NUM_LSCH3_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
#[doc = "Field `OVF_CNT_EN_LSCH3` reader - reg_ovf_cnt_en_lsch3."]
pub struct OVF_CNT_EN_LSCH3_R(crate::FieldReader<bool, bool>);
impl OVF_CNT_EN_LSCH3_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OVF_CNT_EN_LSCH3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OVF_CNT_EN_LSCH3_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `OVF_CNT_EN_LSCH3` writer - reg_ovf_cnt_en_lsch3."]
pub struct OVF_CNT_EN_LSCH3_W<'a> {
    w: &'a mut W,
}
impl<'a> OVF_CNT_EN_LSCH3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Field `OVF_CNT_RESET_LSCH3` writer - reg_ovf_cnt_reset_lsch3."]
pub struct OVF_CNT_RESET_LSCH3_W<'a> {
    w: &'a mut W,
}
impl<'a> OVF_CNT_RESET_LSCH3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    #[doc = "Bits 0:1 - reg_timer_sel_lsch3."]
    #[inline(always)]
    pub fn timer_sel_lsch3(&self) -> TIMER_SEL_LSCH3_R {
        TIMER_SEL_LSCH3_R::new((self.bits & 0x03) as u8)
    }
    #[doc = "Bit 2 - reg_sig_out_en_lsch3."]
    #[inline(always)]
    pub fn sig_out_en_lsch3(&self) -> SIG_OUT_EN_LSCH3_R {
        SIG_OUT_EN_LSCH3_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - reg_idle_lv_lsch3."]
    #[inline(always)]
    pub fn idle_lv_lsch3(&self) -> IDLE_LV_LSCH3_R {
        IDLE_LV_LSCH3_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bits 5:14 - reg_ovf_num_lsch3."]
    #[inline(always)]
    pub fn ovf_num_lsch3(&self) -> OVF_NUM_LSCH3_R {
        OVF_NUM_LSCH3_R::new(((self.bits >> 5) & 0x03ff) as u16)
    }
    #[doc = "Bit 15 - reg_ovf_cnt_en_lsch3."]
    #[inline(always)]
    pub fn ovf_cnt_en_lsch3(&self) -> OVF_CNT_EN_LSCH3_R {
        OVF_CNT_EN_LSCH3_R::new(((self.bits >> 15) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - reg_timer_sel_lsch3."]
    ...
    #[doc = "Bits 5:14 - reg_ovf_num_lsch3."]
    #[inline(always)]
    pub fn ovf_num_lsch3(&mut self) -> OVF_NUM_LSCH3_W {
        OVF_NUM_LSCH3_W { w: self }
    }
    #[doc = "Bit 15 - reg_ovf_cnt_en_lsch3."]
    #[inline(always)]
    pub fn ovf_cnt_en_lsch3(&mut self) -> OVF_CNT_EN_LSCH3_W {
        OVF_CNT_EN_LSCH3_W { w: self }
    }
    #[doc = "Bit 16 - reg_ovf_cnt_reset_lsch3."]
    #[inline(always)]
    pub fn ovf_cnt_reset_lsch3(&mut self) -> OVF_CNT_RESET_LSCH3_W {
        OVF_CNT_RESET_LSCH3_W { w: self }
    }
