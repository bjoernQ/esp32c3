...
#[doc = "Field `DUTY_LSCH2_R` reader - reg_duty_lsch2_r."]
pub struct DUTY_LSCH2_R_R(crate::FieldReader<u32, u32>);
impl DUTY_LSCH2_R_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DUTY_LSCH2_R_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DUTY_LSCH2_R_R {
...
impl R {
    #[doc = "Bits 0:18 - reg_duty_lsch2_r."]
    #[inline(always)]
    pub fn duty_lsch2_r(&self) -> DUTY_LSCH2_R_R {
        DUTY_LSCH2_R_R::new((self.bits & 0x0007_ffff) as u32)
    }
}
