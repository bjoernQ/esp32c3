...
pub struct KEY5_DATA2_R(crate::FieldReader<u32, u32>);
impl KEY5_DATA2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY5_DATA2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY5_DATA2_R {
...
impl R {
    ...
    pub fn key5_data2(&self) -> KEY5_DATA2_R {
        KEY5_DATA2_R::new(self.bits as u32)
    }
}
