...
pub struct KEY0_DATA0_R(crate::FieldReader<u32, u32>);
impl KEY0_DATA0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY0_DATA0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY0_DATA0_R {
...
impl R {
    ...
    pub fn key0_data0(&self) -> KEY0_DATA0_R {
        KEY0_DATA0_R::new(self.bits as u32)
    }
}
