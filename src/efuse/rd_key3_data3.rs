...
pub struct KEY3_DATA3_R(crate::FieldReader<u32, u32>);
impl KEY3_DATA3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY3_DATA3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY3_DATA3_R {
...
impl R {
    ...
    pub fn key3_data3(&self) -> KEY3_DATA3_R {
        KEY3_DATA3_R::new(self.bits as u32)
    }
}
