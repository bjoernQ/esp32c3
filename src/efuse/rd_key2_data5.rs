...
pub struct KEY2_DATA5_R(crate::FieldReader<u32, u32>);
impl KEY2_DATA5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY2_DATA5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY2_DATA5_R {
...
impl R {
    ...
    pub fn key2_data5(&self) -> KEY2_DATA5_R {
        KEY2_DATA5_R::new(self.bits as u32)
    }
}
