...
pub struct KEY5_DATA0_R(crate::FieldReader<u32, u32>);
impl KEY5_DATA0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY5_DATA0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY5_DATA0_R {
...
impl R {
    ...
    pub fn key5_data0(&self) -> KEY5_DATA0_R {
        KEY5_DATA0_R::new(self.bits as u32)
    }
}
