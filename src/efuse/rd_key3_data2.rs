...
pub struct KEY3_DATA2_R(crate::FieldReader<u32, u32>);
impl KEY3_DATA2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY3_DATA2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY3_DATA2_R {
...
impl R {
    ...
    pub fn key3_data2(&self) -> KEY3_DATA2_R {
        KEY3_DATA2_R::new(self.bits as u32)
    }
}
