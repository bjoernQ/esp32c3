...
pub struct SYS_DATA_PART1_5_R(crate::FieldReader<u32, u32>);
impl SYS_DATA_PART1_5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SYS_DATA_PART1_5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SYS_DATA_PART1_5_R {
...
impl R {
    ...
    pub fn sys_data_part1_5(&self) -> SYS_DATA_PART1_5_R {
        SYS_DATA_PART1_5_R::new(self.bits as u32)
    }
}
