...
pub struct PGM_DATA_6_R(crate::FieldReader<u32, u32>);
impl PGM_DATA_6_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PGM_DATA_6_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PGM_DATA_6_R {
...
pub struct PGM_DATA_6_W<'a> {
    w: &'a mut W,
}
impl<'a> PGM_DATA_6_W<'a> {
...
impl R {
    ...
    pub fn pgm_data_6(&self) -> PGM_DATA_6_R {
        PGM_DATA_6_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - The content of the 6th 32-bit data to be programmed."]
