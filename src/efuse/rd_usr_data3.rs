...
pub struct USR_DATA3_R(crate::FieldReader<u32, u32>);
impl USR_DATA3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        USR_DATA3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for USR_DATA3_R {
...
impl R {
    ...
    pub fn usr_data3(&self) -> USR_DATA3_R {
        USR_DATA3_R::new(self.bits as u32)
    }
}
