...
pub struct KEY4_DATA1_R(crate::FieldReader<u32, u32>);
impl KEY4_DATA1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY4_DATA1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY4_DATA1_R {
...
impl R {
    ...
    pub fn key4_data1(&self) -> KEY4_DATA1_R {
        KEY4_DATA1_R::new(self.bits as u32)
    }
}
