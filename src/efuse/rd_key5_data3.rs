...
pub struct KEY5_DATA3_R(crate::FieldReader<u32, u32>);
impl KEY5_DATA3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY5_DATA3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY5_DATA3_R {
...
impl R {
    ...
    pub fn key5_data3(&self) -> KEY5_DATA3_R {
        KEY5_DATA3_R::new(self.bits as u32)
    }
}
