...
pub struct KEY1_DATA1_R(crate::FieldReader<u32, u32>);
impl KEY1_DATA1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY1_DATA1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY1_DATA1_R {
...
impl R {
    ...
    pub fn key1_data1(&self) -> KEY1_DATA1_R {
        KEY1_DATA1_R::new(self.bits as u32)
    }
}
