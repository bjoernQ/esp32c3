...
pub struct KEY5_DATA7_R(crate::FieldReader<u32, u32>);
impl KEY5_DATA7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY5_DATA7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY5_DATA7_R {
...
impl R {
    ...
    pub fn key5_data7(&self) -> KEY5_DATA7_R {
        KEY5_DATA7_R::new(self.bits as u32)
    }
}
