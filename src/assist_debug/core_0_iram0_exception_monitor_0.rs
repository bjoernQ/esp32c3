...
pub struct CORE_0_IRAM0_RECORDING_ADDR_0_R(crate::FieldReader<u32, u32>);
impl CORE_0_IRAM0_RECORDING_ADDR_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_0_IRAM0_RECORDING_ADDR_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_IRAM0_RECORDING_ADDR_0_R {
...
pub struct CORE_0_IRAM0_RECORDING_WR_0_R(crate::FieldReader<bool, bool>);
impl CORE_0_IRAM0_RECORDING_WR_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_IRAM0_RECORDING_WR_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_IRAM0_RECORDING_WR_0_R {
...
pub struct CORE_0_IRAM0_RECORDING_LOADSTORE_0_R(crate::FieldReader<bool, bool>);
impl CORE_0_IRAM0_RECORDING_LOADSTORE_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_IRAM0_RECORDING_LOADSTORE_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_IRAM0_RECORDING_LOADSTORE_0_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn core_0_iram0_recording_wr_0(&self) -> CORE_0_IRAM0_RECORDING_WR_0_R {
        CORE_0_IRAM0_RECORDING_WR_0_R::new(((self.bits >> 24) & 0x01) != 0)
    }
    ...
    pub fn core_0_iram0_recording_loadstore_0(&self) -> CORE_0_IRAM0_RECORDING_LOADSTORE_0_R {
        CORE_0_IRAM0_RECORDING_LOADSTORE_0_R::new(((self.bits >> 25) & 0x01) != 0)
    }
}
