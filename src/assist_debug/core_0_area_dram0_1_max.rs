...
pub struct CORE_0_AREA_DRAM0_1_MAX_R(crate::FieldReader<u32, u32>);
impl CORE_0_AREA_DRAM0_1_MAX_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_0_AREA_DRAM0_1_MAX_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_AREA_DRAM0_1_MAX_R {
...
pub struct CORE_0_AREA_DRAM0_1_MAX_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_AREA_DRAM0_1_MAX_W<'a> {
...
impl R {
    ...
    pub fn core_0_area_dram0_1_max(&self) -> CORE_0_AREA_DRAM0_1_MAX_R {
        CORE_0_AREA_DRAM0_1_MAX_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - reg_core_0_area_dram0_1_max"]
    #[inline(always)]
    pub fn core_0_area_dram0_1_max(&mut self) -> CORE_0_AREA_DRAM0_1_MAX_W {
        CORE_0_AREA_DRAM0_1_MAX_W { w: self }
    }
