...
pub struct CORE_0_AREA_PIF_1_MIN_R(crate::FieldReader<u32, u32>);
impl CORE_0_AREA_PIF_1_MIN_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_0_AREA_PIF_1_MIN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_AREA_PIF_1_MIN_R {
...
pub struct CORE_0_AREA_PIF_1_MIN_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_AREA_PIF_1_MIN_W<'a> {
...
impl R {
    ...
    pub fn core_0_area_pif_1_min(&self) -> CORE_0_AREA_PIF_1_MIN_R {
        CORE_0_AREA_PIF_1_MIN_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - reg_core_0_area_pif_1_min"]
    #[inline(always)]
    pub fn core_0_area_pif_1_min(&mut self) -> CORE_0_AREA_PIF_1_MIN_W {
        CORE_0_AREA_PIF_1_MIN_W { w: self }
    }
