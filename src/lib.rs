#![doc = "Peripheral access API for ESP32-C3 microcontrollers (generated using svd2rust v0.19.0 (f4b0e64 2021-11-02))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl I2S {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const i2s::RegisterBlock = 0x6004_b000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
