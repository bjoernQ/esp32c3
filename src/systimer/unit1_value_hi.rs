...
pub struct TIMER_UNIT1_VALUE_HI_R(crate::FieldReader<u32, u32>);
impl TIMER_UNIT1_VALUE_HI_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TIMER_UNIT1_VALUE_HI_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMER_UNIT1_VALUE_HI_R {
