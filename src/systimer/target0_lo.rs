...
pub struct TIMER_TARGET0_LO_R(crate::FieldReader<u32, u32>);
impl TIMER_TARGET0_LO_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TIMER_TARGET0_LO_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMER_TARGET0_LO_R {
...
pub struct TIMER_TARGET0_LO_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER_TARGET0_LO_W<'a> {
...
impl R {
    ...
    pub fn timer_target0_lo(&self) -> TIMER_TARGET0_LO_R {
        TIMER_TARGET0_LO_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - timer taget0 low 32 bit"]
