...
pub struct OUTFIFO_WDATA_CH1_R(crate::FieldReader<u16, u16>);
impl OUTFIFO_WDATA_CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        OUTFIFO_WDATA_CH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTFIFO_WDATA_CH1_R {
...
pub struct OUTFIFO_WDATA_CH1_W<'a> {
    w: &'a mut W,
}
impl<'a> OUTFIFO_WDATA_CH1_W<'a> {
...
pub struct OUTFIFO_PUSH_CH1_R(crate::FieldReader<bool, bool>);
impl OUTFIFO_PUSH_CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUTFIFO_PUSH_CH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTFIFO_PUSH_CH1_R {
...
pub struct OUTFIFO_PUSH_CH1_W<'a> {
    w: &'a mut W,
}
impl<'a> OUTFIFO_PUSH_CH1_W<'a> {
...
impl R {
    ...
    pub fn outfifo_push_ch1(&self) -> OUTFIFO_PUSH_CH1_R {
        OUTFIFO_PUSH_CH1_R::new(((self.bits >> 9) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:8 - This register stores the data that need to be pushed into DMA FIFO."]
    #[inline(always)]
    pub fn outfifo_wdata_ch1(&mut self) -> OUTFIFO_WDATA_CH1_W {
        OUTFIFO_WDATA_CH1_W { w: self }
    }
    #[doc = "Bit 9 - Set this bit to push data into DMA FIFO."]
    #[inline(always)]
    pub fn outfifo_push_ch1(&mut self) -> OUTFIFO_PUSH_CH1_W {
        OUTFIFO_PUSH_CH1_W { w: self }
    }
