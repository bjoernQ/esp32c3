...
pub struct OUTLINK_DSCR_ADDR_CH2_R(crate::FieldReader<u32, u32>);
...
pub struct OUT_DSCR_STATE_CH2_R(crate::FieldReader<u8, u8>);
...
pub struct OUT_STATE_CH2_R(crate::FieldReader<u8, u8>);
...
impl R {
    ...
    pub fn out_dscr_state_ch2(&self) -> OUT_DSCR_STATE_CH2_R {
        OUT_DSCR_STATE_CH2_R::new(((self.bits >> 18) & 0x03) as u8)
    }
    #[doc = "Bits 20:22 - reserved"]
    #[inline(always)]
    pub fn out_state_ch2(&self) -> OUT_STATE_CH2_R {
        OUT_STATE_CH2_R::new(((self.bits >> 20) & 0x07) as u8)
    }
}
