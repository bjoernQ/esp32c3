...
pub struct PERI_IN_SEL_CH1_R(crate::FieldReader<u8, u8>);
impl PERI_IN_SEL_CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PERI_IN_SEL_CH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PERI_IN_SEL_CH1_R {
...
pub struct PERI_IN_SEL_CH1_W<'a> {
    w: &'a mut W,
}
impl<'a> PERI_IN_SEL_CH1_W<'a> {
...
impl W {
    #[doc = "Bits 0:5 - This register is used to select peripheral for Rx channel 1. 0:SPI2. 1: reserved. 2: UHCI0. 3: I2S0. 4: reserved. 5: reserved. 6: AES. 7: SHA. 8: ADC_DAC."]
    #[inline(always)]
    pub fn peri_in_sel_ch1(&mut self) -> PERI_IN_SEL_CH1_W {
        PERI_IN_SEL_CH1_W { w: self }
    }
