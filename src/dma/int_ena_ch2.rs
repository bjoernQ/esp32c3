...
pub struct IN_DONE_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct IN_SUC_EOF_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct IN_ERR_EOF_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct OUT_DONE_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct OUT_EOF_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct IN_DSCR_ERR_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct OUT_DSCR_ERR_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct IN_DSCR_EMPTY_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct OUT_TOTAL_EOF_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct INFIFO_OVF_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct INFIFO_UDF_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct OUTFIFO_OVF_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
pub struct OUTFIFO_UDF_CH2_INT_ENA_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn in_done_ch2_int_ena(&self) -> IN_DONE_CH2_INT_ENA_R {
        IN_DONE_CH2_INT_ENA_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn in_suc_eof_ch2_int_ena(&self) -> IN_SUC_EOF_CH2_INT_ENA_R {
        IN_SUC_EOF_CH2_INT_ENA_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    ...
    pub fn in_err_eof_ch2_int_ena(&self) -> IN_ERR_EOF_CH2_INT_ENA_R {
        IN_ERR_EOF_CH2_INT_ENA_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    ...
    pub fn in_dscr_err_ch2_int_ena(&self) -> IN_DSCR_ERR_CH2_INT_ENA_R {
        IN_DSCR_ERR_CH2_INT_ENA_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    ...
    pub fn out_dscr_err_ch2_int_ena(&self) -> OUT_DSCR_ERR_CH2_INT_ENA_R {
        OUT_DSCR_ERR_CH2_INT_ENA_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    ...
    pub fn in_dscr_empty_ch2_int_ena(&self) -> IN_DSCR_EMPTY_CH2_INT_ENA_R {
        IN_DSCR_EMPTY_CH2_INT_ENA_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    ...
    pub fn out_total_eof_ch2_int_ena(&self) -> OUT_TOTAL_EOF_CH2_INT_ENA_R {
        OUT_TOTAL_EOF_CH2_INT_ENA_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    ...
    pub fn infifo_ovf_ch2_int_ena(&self) -> INFIFO_OVF_CH2_INT_ENA_R {
        INFIFO_OVF_CH2_INT_ENA_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    ...
    pub fn infifo_udf_ch2_int_ena(&self) -> INFIFO_UDF_CH2_INT_ENA_R {
        INFIFO_UDF_CH2_INT_ENA_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    ...
    pub fn outfifo_ovf_ch2_int_ena(&self) -> OUTFIFO_OVF_CH2_INT_ENA_R {
        OUTFIFO_OVF_CH2_INT_ENA_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    ...
    pub fn outfifo_udf_ch2_int_ena(&self) -> OUTFIFO_UDF_CH2_INT_ENA_R {
        OUTFIFO_UDF_CH2_INT_ENA_R::new(((self.bits >> 12) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - The interrupt enable bit for the IN_DONE_CH_INT interrupt."]
