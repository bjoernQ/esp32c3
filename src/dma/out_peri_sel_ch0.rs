...
pub struct PERI_OUT_SEL_CH0_R(crate::FieldReader<u8, u8>);
impl PERI_OUT_SEL_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PERI_OUT_SEL_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PERI_OUT_SEL_CH0_R {
...
pub struct PERI_OUT_SEL_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> PERI_OUT_SEL_CH0_W<'a> {
