...
pub struct OUT_RST_CH2_R(crate::FieldReader<bool, bool>);
impl OUT_RST_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUT_RST_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_RST_CH2_R {
...
pub struct OUT_RST_CH2_W<'a> {
    w: &'a mut W,
}
impl<'a> OUT_RST_CH2_W<'a> {
...
pub struct OUT_LOOP_TEST_CH2_R(crate::FieldReader<bool, bool>);
impl OUT_LOOP_TEST_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUT_LOOP_TEST_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_LOOP_TEST_CH2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OUT_LOOP_TEST_CH2_W<'a> {
    w: &'a mut W,
}
impl<'a> OUT_LOOP_TEST_CH2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct OUT_AUTO_WRBACK_CH2_R(crate::FieldReader<bool, bool>);
impl OUT_AUTO_WRBACK_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUT_AUTO_WRBACK_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_AUTO_WRBACK_CH2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OUT_AUTO_WRBACK_CH2_W<'a> {
    w: &'a mut W,
}
impl<'a> OUT_AUTO_WRBACK_CH2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct OUT_EOF_MODE_CH2_R(crate::FieldReader<bool, bool>);
impl OUT_EOF_MODE_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUT_EOF_MODE_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_EOF_MODE_CH2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OUT_EOF_MODE_CH2_W<'a> {
    w: &'a mut W,
}
impl<'a> OUT_EOF_MODE_CH2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct OUTDSCR_BURST_EN_CH2_R(crate::FieldReader<bool, bool>);
impl OUTDSCR_BURST_EN_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUTDSCR_BURST_EN_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTDSCR_BURST_EN_CH2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OUTDSCR_BURST_EN_CH2_W<'a> {
    w: &'a mut W,
}
impl<'a> OUTDSCR_BURST_EN_CH2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct OUT_DATA_BURST_EN_CH2_R(crate::FieldReader<bool, bool>);
impl OUT_DATA_BURST_EN_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUT_DATA_BURST_EN_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_DATA_BURST_EN_CH2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OUT_DATA_BURST_EN_CH2_W<'a> {
    w: &'a mut W,
}
impl<'a> OUT_DATA_BURST_EN_CH2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn out_rst_ch2(&self) -> OUT_RST_CH2_R {
        OUT_RST_CH2_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - reserved"]
    #[inline(always)]
    pub fn out_loop_test_ch2(&self) -> OUT_LOOP_TEST_CH2_R {
        OUT_LOOP_TEST_CH2_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    ...
    pub fn out_auto_wrback_ch2(&self) -> OUT_AUTO_WRBACK_CH2_R {
        OUT_AUTO_WRBACK_CH2_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    ...
    pub fn out_eof_mode_ch2(&self) -> OUT_EOF_MODE_CH2_R {
        OUT_EOF_MODE_CH2_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    ...
    pub fn outdscr_burst_en_ch2(&self) -> OUTDSCR_BURST_EN_CH2_R {
        OUTDSCR_BURST_EN_CH2_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    ...
    pub fn out_data_burst_en_ch2(&self) -> OUT_DATA_BURST_EN_CH2_R {
        OUT_DATA_BURST_EN_CH2_R::new(((self.bits >> 5) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - This bit is used to reset DMA channel 2 Tx FSM and Tx FIFO pointer."]
    #[inline(always)]
    pub fn out_rst_ch2(&mut self) -> OUT_RST_CH2_W {
        OUT_RST_CH2_W { w: self }
    }
    #[doc = "Bit 1 - reserved"]
    #[inline(always)]
    pub fn out_loop_test_ch2(&mut self) -> OUT_LOOP_TEST_CH2_W {
        OUT_LOOP_TEST_CH2_W { w: self }
    }
    #[doc = "Bit 2 - Set this bit to enable automatic outlink-writeback when all the data in tx buffer has been transmitted."]
    #[inline(always)]
    pub fn out_auto_wrback_ch2(&mut self) -> OUT_AUTO_WRBACK_CH2_W {
        OUT_AUTO_WRBACK_CH2_W { w: self }
    }
    #[doc = "Bit 3 - EOF flag generation mode when transmitting data. 1: EOF flag for Tx channel 2 is generated when data need to transmit has been popped from FIFO in DMA"]
    #[inline(always)]
    pub fn out_eof_mode_ch2(&mut self) -> OUT_EOF_MODE_CH2_W {
        OUT_EOF_MODE_CH2_W { w: self }
    }
    #[doc = "Bit 4 - Set this bit to 1 to enable INCR burst transfer for Tx channel 2 reading link descriptor when accessing internal SRAM."]
    #[inline(always)]
    pub fn outdscr_burst_en_ch2(&mut self) -> OUTDSCR_BURST_EN_CH2_W {
        OUTDSCR_BURST_EN_CH2_W { w: self }
    }
    #[doc = "Bit 5 - Set this bit to 1 to enable INCR burst transfer for Tx channel 2 transmitting data when accessing internal SRAM."]
    #[inline(always)]
    pub fn out_data_burst_en_ch2(&mut self) -> OUT_DATA_BURST_EN_CH2_W {
        OUT_DATA_BURST_EN_CH2_W { w: self }
    }
