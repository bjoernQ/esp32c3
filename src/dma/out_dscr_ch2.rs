...
pub struct OUTLINK_DSCR_CH2_R(crate::FieldReader<u32, u32>);
impl OUTLINK_DSCR_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        OUTLINK_DSCR_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTLINK_DSCR_CH2_R {
...
impl R {
    ...
    pub fn outlink_dscr_ch2(&self) -> OUTLINK_DSCR_CH2_R {
        OUTLINK_DSCR_CH2_R::new(self.bits as u32)
    }
}
