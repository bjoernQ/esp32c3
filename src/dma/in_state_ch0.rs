...
pub struct INLINK_DSCR_ADDR_CH0_R(crate::FieldReader<u32, u32>);
impl INLINK_DSCR_ADDR_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        INLINK_DSCR_ADDR_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INLINK_DSCR_ADDR_CH0_R {
...
pub struct IN_DSCR_STATE_CH0_R(crate::FieldReader<u8, u8>);
impl IN_DSCR_STATE_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        IN_DSCR_STATE_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IN_DSCR_STATE_CH0_R {
...
pub struct IN_STATE_CH0_R(crate::FieldReader<u8, u8>);
impl IN_STATE_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        IN_STATE_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IN_STATE_CH0_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn in_dscr_state_ch0(&self) -> IN_DSCR_STATE_CH0_R {
        IN_DSCR_STATE_CH0_R::new(((self.bits >> 18) & 0x03) as u8)
    }
    #[doc = "Bits 20:22 - reserved"]
    #[inline(always)]
    pub fn in_state_ch0(&self) -> IN_STATE_CH0_R {
        IN_STATE_CH0_R::new(((self.bits >> 20) & 0x07) as u8)
    }
}
