...
pub struct OUT_EOF_BFR_DES_ADDR_CH0_R(crate::FieldReader<u32, u32>);
impl OUT_EOF_BFR_DES_ADDR_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        OUT_EOF_BFR_DES_ADDR_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_EOF_BFR_DES_ADDR_CH0_R {
...
impl R {
    ...
    pub fn out_eof_bfr_des_addr_ch0(&self) -> OUT_EOF_BFR_DES_ADDR_CH0_R {
        OUT_EOF_BFR_DES_ADDR_CH0_R::new(self.bits as u32)
    }
}
