...
pub struct OUTLINK_ADDR_CH0_R(crate::FieldReader<u32, u32>);
impl OUTLINK_ADDR_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        OUTLINK_ADDR_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTLINK_ADDR_CH0_R {
...
pub struct OUTLINK_ADDR_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> OUTLINK_ADDR_CH0_W<'a> {
...
pub struct OUTLINK_STOP_CH0_R(crate::FieldReader<bool, bool>);
impl OUTLINK_STOP_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUTLINK_STOP_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTLINK_STOP_CH0_R {
...
pub struct OUTLINK_STOP_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> OUTLINK_STOP_CH0_W<'a> {
...
pub struct OUTLINK_START_CH0_R(crate::FieldReader<bool, bool>);
impl OUTLINK_START_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct OUTLINK_START_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> OUTLINK_START_CH0_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct OUTLINK_RESTART_CH0_R(crate::FieldReader<bool, bool>);
impl OUTLINK_RESTART_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUTLINK_RESTART_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTLINK_RESTART_CH0_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OUTLINK_RESTART_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> OUTLINK_RESTART_CH0_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct OUTLINK_PARK_CH0_R(crate::FieldReader<bool, bool>);
impl OUTLINK_PARK_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        OUTLINK_PARK_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUTLINK_PARK_CH0_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    pub fn outlink_restart_ch0(&self) -> OUTLINK_RESTART_CH0_R {
        OUTLINK_RESTART_CH0_R::new(((self.bits >> 22) & 0x01) != 0)
    }
    ...
    pub fn outlink_park_ch0(&self) -> OUTLINK_PARK_CH0_R {
        OUTLINK_PARK_CH0_R::new(((self.bits >> 23) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:19 - This register stores the 20 least significant bits of the first outlink descriptor's address."]
