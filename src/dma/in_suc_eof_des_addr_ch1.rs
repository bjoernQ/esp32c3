...
pub struct IN_SUC_EOF_DES_ADDR_CH1_R(crate::FieldReader<u32, u32>);
impl IN_SUC_EOF_DES_ADDR_CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        IN_SUC_EOF_DES_ADDR_CH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IN_SUC_EOF_DES_ADDR_CH1_R {
...
impl R {
    ...
    pub fn in_suc_eof_des_addr_ch1(&self) -> IN_SUC_EOF_DES_ADDR_CH1_R {
        IN_SUC_EOF_DES_ADDR_CH1_R::new(self.bits as u32)
    }
}
