...
pub struct IN_ERR_EOF_DES_ADDR_CH0_R(crate::FieldReader<u32, u32>);
impl IN_ERR_EOF_DES_ADDR_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        IN_ERR_EOF_DES_ADDR_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IN_ERR_EOF_DES_ADDR_CH0_R {
...
impl R {
    ...
    pub fn in_err_eof_des_addr_ch0(&self) -> IN_ERR_EOF_DES_ADDR_CH0_R {
        IN_ERR_EOF_DES_ADDR_CH0_R::new(self.bits as u32)
    }
}
