...
pub struct INLINK_DSCR_CH2_R(crate::FieldReader<u32, u32>);
impl INLINK_DSCR_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        INLINK_DSCR_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INLINK_DSCR_CH2_R {
...
impl R {
    ...
    pub fn inlink_dscr_ch2(&self) -> INLINK_DSCR_CH2_R {
        INLINK_DSCR_CH2_R::new(self.bits as u32)
    }
}
