...
pub struct INLINK_DSCR_ADDR_CH2_R(crate::FieldReader<u32, u32>);
impl INLINK_DSCR_ADDR_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        INLINK_DSCR_ADDR_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INLINK_DSCR_ADDR_CH2_R {
...
pub struct IN_DSCR_STATE_CH2_R(crate::FieldReader<u8, u8>);
impl IN_DSCR_STATE_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        IN_DSCR_STATE_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IN_DSCR_STATE_CH2_R {
...
pub struct IN_STATE_CH2_R(crate::FieldReader<u8, u8>);
impl IN_STATE_CH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        IN_STATE_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IN_STATE_CH2_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
