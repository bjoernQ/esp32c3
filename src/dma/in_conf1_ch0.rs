...
pub struct IN_CHECK_OWNER_CH0_R(crate::FieldReader<bool, bool>);
impl IN_CHECK_OWNER_CH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        IN_CHECK_OWNER_CH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IN_CHECK_OWNER_CH0_R {
...
pub struct IN_CHECK_OWNER_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> IN_CHECK_OWNER_CH0_W<'a> {
...
impl R {
    ...
    pub fn in_check_owner_ch0(&self) -> IN_CHECK_OWNER_CH0_R {
        IN_CHECK_OWNER_CH0_R::new(((self.bits >> 12) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 12 - Set this bit to enable checking the owner attribute of the link descriptor."]
