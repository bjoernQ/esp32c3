...
pub struct OUT_EP0_STATE_R(crate::FieldReader<u8, u8>);
impl OUT_EP0_STATE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        OUT_EP0_STATE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_EP0_STATE_R {
...
pub struct OUT_EP0_WR_ADDR_R(crate::FieldReader<u8, u8>);
impl OUT_EP0_WR_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        OUT_EP0_WR_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_EP0_WR_ADDR_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct OUT_EP0_RD_ADDR_R(crate::FieldReader<u8, u8>);
impl OUT_EP0_RD_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        OUT_EP0_RD_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OUT_EP0_RD_ADDR_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
