...
pub struct IN_EP2_STATE_R(crate::FieldReader<u8, u8>);
impl IN_EP2_STATE_R {
    #[inline(always)]
...
pub struct IN_EP2_WR_ADDR_R(crate::FieldReader<u8, u8>);
...
pub struct IN_EP2_RD_ADDR_R(crate::FieldReader<u8, u8>);
...
impl R {
    ...
    pub fn in_ep2_state(&self) -> IN_EP2_STATE_R {
        IN_EP2_STATE_R::new((self.bits & 0x03) as u8)
    }
