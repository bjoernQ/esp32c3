...
pub struct SEND_Q2_WORD0_R(crate::FieldReader<u32, u32>);
impl SEND_Q2_WORD0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SEND_Q2_WORD0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SEND_Q2_WORD0_R {
...
pub struct SEND_Q2_WORD0_W<'a> {
    w: &'a mut W,
}
impl<'a> SEND_Q2_WORD0_W<'a> {
...
impl R {
    ...
    pub fn send_q2_word0(&self) -> SEND_Q2_WORD0_R {
        SEND_Q2_WORD0_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - a"]
    #[inline(always)]
    pub fn send_q2_word0(&mut self) -> SEND_Q2_WORD0_W {
        SEND_Q2_WORD0_W { w: self }
    }
