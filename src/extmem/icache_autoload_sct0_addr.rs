...
pub struct ICACHE_AUTOLOAD_SCT0_ADDR_R(crate::FieldReader<u32, u32>);
impl ICACHE_AUTOLOAD_SCT0_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        ICACHE_AUTOLOAD_SCT0_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICACHE_AUTOLOAD_SCT0_ADDR_R {
...
pub struct ICACHE_AUTOLOAD_SCT0_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> ICACHE_AUTOLOAD_SCT0_ADDR_W<'a> {
...
impl R {
    ...
    pub fn icache_autoload_sct0_addr(&self) -> ICACHE_AUTOLOAD_SCT0_ADDR_R {
        ICACHE_AUTOLOAD_SCT0_ADDR_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the start virtual address of the first section for autoload operation. It should be combined with icache_autoload_sct0_ena."]
    #[inline(always)]
    pub fn icache_autoload_sct0_addr(&mut self) -> ICACHE_AUTOLOAD_SCT0_ADDR_W {
        ICACHE_AUTOLOAD_SCT0_ADDR_W { w: self }
    }
