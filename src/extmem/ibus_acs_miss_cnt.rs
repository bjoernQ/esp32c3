...
pub struct IBUS_ACS_MISS_CNT_R(crate::FieldReader<u32, u32>);
impl IBUS_ACS_MISS_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        IBUS_ACS_MISS_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IBUS_ACS_MISS_CNT_R {
...
impl R {
    ...
    pub fn ibus_acs_miss_cnt(&self) -> IBUS_ACS_MISS_CNT_R {
        IBUS_ACS_MISS_CNT_R::new(self.bits as u32)
    }
}
