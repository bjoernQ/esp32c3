...
impl ICACHE_PRELOCK_SCT1_ADDR_R {
    ...
    pub(crate) fn new(bits: u32) -> Self {
        ICACHE_PRELOCK_SCT1_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICACHE_PRELOCK_SCT1_ADDR_R {
...
pub struct ICACHE_PRELOCK_SCT1_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> ICACHE_PRELOCK_SCT1_ADDR_W<'a> {
...
impl R {
    ...
    pub fn icache_prelock_sct1_addr(&self) -> ICACHE_PRELOCK_SCT1_ADDR_R {
        ICACHE_PRELOCK_SCT1_ADDR_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the second start virtual address of data prelock, which is combined with ICACHE_PRELOCK_SCT1_SIZE_REG"]
    #[inline(always)]
    pub fn icache_prelock_sct1_addr(&mut self) -> ICACHE_PRELOCK_SCT1_ADDR_W {
        ICACHE_PRELOCK_SCT1_ADDR_W { w: self }
    }
