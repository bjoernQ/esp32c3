...
pub struct CORE0_IBUS_ATTR_R(crate::FieldReader<u8, u8>);
impl CORE0_IBUS_ATTR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE0_IBUS_ATTR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE0_IBUS_ATTR_R {
...
pub struct CORE0_IBUS_WORLD_R(crate::FieldReader<bool, bool>);
impl CORE0_IBUS_WORLD_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE0_IBUS_WORLD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE0_IBUS_WORLD_R {
...
impl R {
    ...
    pub fn core0_ibus_attr(&self) -> CORE0_IBUS_ATTR_R {
        CORE0_IBUS_ATTR_R::new((self.bits & 0x07) as u8)
    }
    ...
    pub fn core0_ibus_world(&self) -> CORE0_IBUS_WORLD_R {
        CORE0_IBUS_WORLD_R::new(((self.bits >> 3) & 0x01) != 0)
    }
}
