...
pub struct ICACHE_AUTOLOAD_SCT0_SIZE_R(crate::FieldReader<u32, u32>);
impl ICACHE_AUTOLOAD_SCT0_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        ICACHE_AUTOLOAD_SCT0_SIZE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICACHE_AUTOLOAD_SCT0_SIZE_R {
...
pub struct ICACHE_AUTOLOAD_SCT0_SIZE_W<'a> {
    w: &'a mut W,
}
impl<'a> ICACHE_AUTOLOAD_SCT0_SIZE_W<'a> {
...
impl W {
    #[doc = "Bits 0:26 - The bits are used to configure the length of the first section for autoload operation. It should be combined with icache_autoload_sct0_ena."]
    #[inline(always)]
    pub fn icache_autoload_sct0_size(&mut self) -> ICACHE_AUTOLOAD_SCT0_SIZE_W {
        ICACHE_AUTOLOAD_SCT0_SIZE_W { w: self }
    }
