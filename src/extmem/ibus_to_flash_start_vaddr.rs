...
pub struct IBUS_TO_FLASH_START_VADDR_R(crate::FieldReader<u32, u32>);
impl IBUS_TO_FLASH_START_VADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        IBUS_TO_FLASH_START_VADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IBUS_TO_FLASH_START_VADDR_R {
...
pub struct IBUS_TO_FLASH_START_VADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> IBUS_TO_FLASH_START_VADDR_W<'a> {
...
impl R {
    ...
    pub fn ibus_to_flash_start_vaddr(&self) -> IBUS_TO_FLASH_START_VADDR_R {
        IBUS_TO_FLASH_START_VADDR_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the start virtual address of ibus to access flash. The register is used to give constraints to ibus access counter."]
    ...
    pub fn ibus_to_flash_start_vaddr(&mut self) -> IBUS_TO_FLASH_START_VADDR_W {
        IBUS_TO_FLASH_START_VADDR_W { w: self }
    }
