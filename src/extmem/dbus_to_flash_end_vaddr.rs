...
pub struct DBUS_TO_FLASH_END_VADDR_R(crate::FieldReader<u32, u32>);
impl DBUS_TO_FLASH_END_VADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DBUS_TO_FLASH_END_VADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DBUS_TO_FLASH_END_VADDR_R {
...
pub struct DBUS_TO_FLASH_END_VADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> DBUS_TO_FLASH_END_VADDR_W<'a> {
...
impl R {
    ...
    pub fn dbus_to_flash_end_vaddr(&self) -> DBUS_TO_FLASH_END_VADDR_R {
        DBUS_TO_FLASH_END_VADDR_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the end virtual address of dbus to access flash. The register is used to give constraints to dbus access counter."]
    ...
    pub fn dbus_to_flash_end_vaddr(&mut self) -> DBUS_TO_FLASH_END_VADDR_W {
        DBUS_TO_FLASH_END_VADDR_W { w: self }
    }
