...
pub struct RTC_CALI_TIMEOUT_R(crate::FieldReader<bool, bool>);
...
pub struct RTC_CALI_TIMEOUT_RST_CNT_R(crate::FieldReader<u8, u8>);
...
pub struct RTC_CALI_TIMEOUT_THRES_R(crate::FieldReader<u32, u32>);
