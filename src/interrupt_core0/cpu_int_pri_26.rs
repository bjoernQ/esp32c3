...
pub struct CPU_PRI_26_MAP_R(crate::FieldReader<u8, u8>);
impl CPU_PRI_26_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CPU_PRI_26_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CPU_PRI_26_MAP_R {
...
pub struct CPU_PRI_26_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> CPU_PRI_26_MAP_W<'a> {
