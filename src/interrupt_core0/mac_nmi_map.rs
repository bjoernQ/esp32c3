...
pub struct MAC_NMI_MAP_R(crate::FieldReader<u8, u8>);
impl MAC_NMI_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        MAC_NMI_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MAC_NMI_MAP_R {
...
pub struct MAC_NMI_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> MAC_NMI_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - reg_core0_mac_nmi_map"]
    #[inline(always)]
    pub fn mac_nmi_map(&mut self) -> MAC_NMI_MAP_W {
        MAC_NMI_MAP_W { w: self }
    }
