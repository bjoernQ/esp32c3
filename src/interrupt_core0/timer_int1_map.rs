...
pub struct TIMER_INT1_MAP_R(crate::FieldReader<u8, u8>);
impl TIMER_INT1_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        TIMER_INT1_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMER_INT1_MAP_R {
...
pub struct TIMER_INT1_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER_INT1_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - reg_core0_timer_int1_map"]
    #[inline(always)]
    pub fn timer_int1_map(&mut self) -> TIMER_INT1_MAP_W {
        TIMER_INT1_MAP_W { w: self }
    }
