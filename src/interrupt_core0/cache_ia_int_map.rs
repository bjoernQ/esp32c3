...
pub struct CACHE_IA_INT_MAP_R(crate::FieldReader<u8, u8>);
impl CACHE_IA_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CACHE_IA_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CACHE_IA_INT_MAP_R {
...
pub struct CACHE_IA_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> CACHE_IA_INT_MAP_W<'a> {
