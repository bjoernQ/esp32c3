...
pub struct RSA_INT_MAP_R(crate::FieldReader<u8, u8>);
impl RSA_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RSA_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RSA_INT_MAP_R {
...
pub struct RSA_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> RSA_INT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - reg_core0_rsa_int_map"]
    #[inline(always)]
    pub fn rsa_int_map(&mut self) -> RSA_INT_MAP_W {
        RSA_INT_MAP_W { w: self }
    }
