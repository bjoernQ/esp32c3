...
pub struct DMA_CH0_INT_MAP_R(crate::FieldReader<u8, u8>);
impl DMA_CH0_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        DMA_CH0_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA_CH0_INT_MAP_R {
...
pub struct DMA_CH0_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> DMA_CH0_INT_MAP_W<'a> {
