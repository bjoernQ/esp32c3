...
pub struct CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP_R {
...
pub struct CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP_W<'a> {
...
impl W {
    ...
    pub fn core_0_pif_pms_monitor_violate_intr_map(
        &mut self,
    ) -> CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP_W {
        CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP_W { w: self }
    }
