...
pub struct SYSTIMER_TARGET2_INT_MAP_R(crate::FieldReader<u8, u8>);
impl SYSTIMER_TARGET2_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SYSTIMER_TARGET2_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SYSTIMER_TARGET2_INT_MAP_R {
...
pub struct SYSTIMER_TARGET2_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> SYSTIMER_TARGET2_INT_MAP_W<'a> {
...
impl W {
    ...
    pub fn systimer_target2_int_map(&mut self) -> SYSTIMER_TARGET2_INT_MAP_W {
        SYSTIMER_TARGET2_INT_MAP_W { w: self }
    }
