...
pub struct RTC_CORE_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl RTC_CORE_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RTC_CORE_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RTC_CORE_INTR_MAP_R {
...
pub struct RTC_CORE_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> RTC_CORE_INTR_MAP_W<'a> {
