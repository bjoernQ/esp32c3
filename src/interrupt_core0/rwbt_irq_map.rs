...
pub struct RWBT_IRQ_MAP_R(crate::FieldReader<u8, u8>);
impl RWBT_IRQ_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RWBT_IRQ_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RWBT_IRQ_MAP_R {
...
pub struct RWBT_IRQ_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> RWBT_IRQ_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - reg_core0_rwbt_irq_map"]
    #[inline(always)]
    pub fn rwbt_irq_map(&mut self) -> RWBT_IRQ_MAP_W {
        RWBT_IRQ_MAP_W { w: self }
    }
