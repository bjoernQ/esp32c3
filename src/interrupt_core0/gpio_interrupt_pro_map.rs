...
pub struct GPIO_INTERRUPT_PRO_MAP_R(crate::FieldReader<u8, u8>);
impl GPIO_INTERRUPT_PRO_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        GPIO_INTERRUPT_PRO_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GPIO_INTERRUPT_PRO_MAP_R {
...
pub struct GPIO_INTERRUPT_PRO_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> GPIO_INTERRUPT_PRO_MAP_W<'a> {
...
impl W {
    ...
    pub fn gpio_interrupt_pro_map(&mut self) -> GPIO_INTERRUPT_PRO_MAP_W {
        GPIO_INTERRUPT_PRO_MAP_W { w: self }
    }
