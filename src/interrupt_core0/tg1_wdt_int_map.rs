...
pub struct TG1_WDT_INT_MAP_R(crate::FieldReader<u8, u8>);
impl TG1_WDT_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        TG1_WDT_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TG1_WDT_INT_MAP_R {
...
pub struct TG1_WDT_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> TG1_WDT_INT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4 - reg_core0_tg1_wdt_int_map"]
    #[inline(always)]
    pub fn tg1_wdt_int_map(&mut self) -> TG1_WDT_INT_MAP_W {
        TG1_WDT_INT_MAP_W { w: self }
    }
