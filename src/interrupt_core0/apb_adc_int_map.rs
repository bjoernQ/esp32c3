...
pub struct APB_ADC_INT_MAP_R(crate::FieldReader<u8, u8>);
impl APB_ADC_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        APB_ADC_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APB_ADC_INT_MAP_R {
...
pub struct APB_ADC_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> APB_ADC_INT_MAP_W<'a> {
