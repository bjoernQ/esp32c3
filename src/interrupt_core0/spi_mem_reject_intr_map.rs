...
pub struct SPI_MEM_REJECT_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl SPI_MEM_REJECT_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SPI_MEM_REJECT_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SPI_MEM_REJECT_INTR_MAP_R {
...
pub struct SPI_MEM_REJECT_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> SPI_MEM_REJECT_INTR_MAP_W<'a> {
...
impl W {
    ...
    pub fn spi_mem_reject_intr_map(&mut self) -> SPI_MEM_REJECT_INTR_MAP_W {
        SPI_MEM_REJECT_INTR_MAP_W { w: self }
    }
