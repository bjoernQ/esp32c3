...
pub struct CPU_INTR_FROM_CPU_2_MAP_R(crate::FieldReader<u8, u8>);
impl CPU_INTR_FROM_CPU_2_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CPU_INTR_FROM_CPU_2_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CPU_INTR_FROM_CPU_2_MAP_R {
...
pub struct CPU_INTR_FROM_CPU_2_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> CPU_INTR_FROM_CPU_2_MAP_W<'a> {
...
impl W {
    ...
    pub fn cpu_intr_from_cpu_2_map(&mut self) -> CPU_INTR_FROM_CPU_2_MAP_W {
        CPU_INTR_FROM_CPU_2_MAP_W { w: self }
    }
