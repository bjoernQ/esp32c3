...
pub struct TG_T0_INT_MAP_R(crate::FieldReader<u8, u8>);
impl TG_T0_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        TG_T0_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TG_T0_INT_MAP_R {
...
pub struct TG_T0_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> TG_T0_INT_MAP_W<'a> {
