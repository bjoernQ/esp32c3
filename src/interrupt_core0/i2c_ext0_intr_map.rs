...
pub struct I2C_EXT0_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl I2C_EXT0_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        I2C_EXT0_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2C_EXT0_INTR_MAP_R {
...
pub struct I2C_EXT0_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> I2C_EXT0_INTR_MAP_W<'a> {
