...
pub struct ICACHE_SYNC_INT_MAP_R(crate::FieldReader<u8, u8>);
impl ICACHE_SYNC_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        ICACHE_SYNC_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ICACHE_SYNC_INT_MAP_R {
...
pub struct ICACHE_SYNC_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> ICACHE_SYNC_INT_MAP_W<'a> {
