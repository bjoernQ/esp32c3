...
pub struct SHA_INT_MAP_R(crate::FieldReader<u8, u8>);
impl SHA_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SHA_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SHA_INT_MAP_R {
...
pub struct SHA_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> SHA_INT_MAP_W<'a> {
