...
pub struct BT_BB_INT_MAP_R(crate::FieldReader<u8, u8>);
impl BT_BB_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        BT_BB_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BT_BB_INT_MAP_R {
...
pub struct BT_BB_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> BT_BB_INT_MAP_W<'a> {
