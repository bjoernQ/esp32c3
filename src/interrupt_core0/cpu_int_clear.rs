...
pub struct CPU_INT_CLEAR_R(crate::FieldReader<u32, u32>);
impl CPU_INT_CLEAR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CPU_INT_CLEAR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CPU_INT_CLEAR_R {
...
pub struct CPU_INT_CLEAR_W<'a> {
    w: &'a mut W,
}
impl<'a> CPU_INT_CLEAR_W<'a> {
...
impl R {
    ...
    pub fn cpu_int_clear(&self) -> CPU_INT_CLEAR_R {
        CPU_INT_CLEAR_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - reg_core0_cpu_int_clear"]
