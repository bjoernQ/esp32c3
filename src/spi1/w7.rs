...
pub struct BUF7_R(crate::FieldReader<u32, u32>);
impl BUF7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BUF7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BUF7_R {
...
impl R {
    ...
    pub fn buf7(&self) -> BUF7_R {
        BUF7_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn buf7(&mut self) -> BUF7_W {
        BUF7_W { w: self }
    }
