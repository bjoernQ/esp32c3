...
#[doc = "Field `DIV_CNT_CH3` reader - reg_div_cnt_ch3."]
pub struct DIV_CNT_CH3_R(crate::FieldReader<u8, u8>);
impl DIV_CNT_CH3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        DIV_CNT_CH3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DIV_CNT_CH3_R {
...
#[doc = "Field `DIV_CNT_CH3` writer - reg_div_cnt_ch3."]
...
#[doc = "Field `IDLE_THRES_CH3` reader - reg_idle_thres_ch3."]
pub struct IDLE_THRES_CH3_R(crate::FieldReader<u16, u16>);
impl IDLE_THRES_CH3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        IDLE_THRES_CH3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IDLE_THRES_CH3_R {
...
#[doc = "Field `IDLE_THRES_CH3` writer - reg_idle_thres_ch3."]
...
#[doc = "Field `MEM_SIZE_CH3` reader - reg_mem_size_ch3."]
pub struct MEM_SIZE_CH3_R(crate::FieldReader<u8, u8>);
impl MEM_SIZE_CH3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        MEM_SIZE_CH3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MEM_SIZE_CH3_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `MEM_SIZE_CH3` writer - reg_mem_size_ch3."]
...
#[doc = "Field `CARRIER_EN_CH3` reader - reg_carrier_en_ch3."]
pub struct CARRIER_EN_CH3_R(crate::FieldReader<bool, bool>);
impl CARRIER_EN_CH3_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CARRIER_EN_CH3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CARRIER_EN_CH3_R {
...
#[doc = "Field `CARRIER_EN_CH3` writer - reg_carrier_en_ch3."]
...
#[doc = "Field `CARRIER_OUT_LV_CH3` reader - reg_carrier_out_lv_ch3."]
pub struct CARRIER_OUT_LV_CH3_R(crate::FieldReader<bool, bool>);
impl CARRIER_OUT_LV_CH3_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CARRIER_OUT_LV_CH3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CARRIER_OUT_LV_CH3_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `CARRIER_OUT_LV_CH3` writer - reg_carrier_out_lv_ch3."]
...
#[doc = "`reset()` method sets CH3CONF0 to value 0x30ff_ff02"]
