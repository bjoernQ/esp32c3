...
pub struct KEY_3_R(crate::FieldReader<u32, u32>);
impl KEY_3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY_3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY_3_R {
...
impl R {
    ...
    pub fn key_3(&self) -> KEY_3_R {
        KEY_3_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - This bits stores key_3 that is a part of key material."]
    #[inline(always)]
    pub fn key_3(&mut self) -> KEY_3_W {
        KEY_3_W { w: self }
    }
