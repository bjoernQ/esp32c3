...
pub struct KEY_2_R(crate::FieldReader<u32, u32>);
impl KEY_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY_2_R {
