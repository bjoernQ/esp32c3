...
pub struct TEXT_IN_1_R(crate::FieldReader<u32, u32>);
impl TEXT_IN_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TEXT_IN_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TEXT_IN_1_R {
...
pub struct TEXT_IN_1_W<'a> {
    w: &'a mut W,
}
impl<'a> TEXT_IN_1_W<'a> {
...
impl R {
    ...
    pub fn text_in_1(&self) -> TEXT_IN_1_R {
        TEXT_IN_1_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - This bits stores text_in_1 that is a part of source text material."]
    #[inline(always)]
    pub fn text_in_1(&mut self) -> TEXT_IN_1_W {
        TEXT_IN_1_W { w: self }
    }
