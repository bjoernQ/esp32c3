...
pub struct KEY_0_R(crate::FieldReader<u32, u32>);
impl KEY_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        KEY_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for KEY_0_R {
...
impl R {
    ...
    pub fn key_0(&self) -> KEY_0_R {
        KEY_0_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - This bits stores key_0 that is a part of key material."]
    #[inline(always)]
    pub fn key_0(&mut self) -> KEY_0_W {
        KEY_0_W { w: self }
    }
