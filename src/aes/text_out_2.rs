...
pub struct TEXT_OUT_2_R(crate::FieldReader<u32, u32>);
impl TEXT_OUT_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TEXT_OUT_2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TEXT_OUT_2_R {
...
pub struct TEXT_OUT_2_W<'a> {
    w: &'a mut W,
}
impl<'a> TEXT_OUT_2_W<'a> {
...
impl R {
    ...
    pub fn text_out_2(&self) -> TEXT_OUT_2_R {
        TEXT_OUT_2_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - This bits stores text_out_2 that is a part of result text material."]
