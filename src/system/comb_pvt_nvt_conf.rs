...
impl COMB_PATH_LEN_NVT_R {
    ...
    pub(crate) fn new(bits: u8) -> Self {
        COMB_PATH_LEN_NVT_R(crate::FieldReader::new(bits))
    }
}
...
pub struct COMB_PATH_LEN_NVT_W<'a> {
    w: &'a mut W,
}
impl<'a> COMB_PATH_LEN_NVT_W<'a> {
...
pub struct COMB_ERR_CNT_CLR_NVT_W<'a> {
    w: &'a mut W,
}
impl<'a> COMB_ERR_CNT_CLR_NVT_W<'a> {
...
impl COMB_PVT_MONITOR_EN_NVT_R {
    ...
    pub(crate) fn new(bits: bool) -> Self {
        COMB_PVT_MONITOR_EN_NVT_R(crate::FieldReader::new(bits))
    }
}
...
pub struct COMB_PVT_MONITOR_EN_NVT_W<'a> {
    w: &'a mut W,
}
impl<'a> COMB_PVT_MONITOR_EN_NVT_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn comb_pvt_monitor_en_nvt(&self) -> COMB_PVT_MONITOR_EN_NVT_R {
        COMB_PVT_MONITOR_EN_NVT_R::new(((self.bits >> 6) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:4 - reg_comb_path_len_nvt"]
