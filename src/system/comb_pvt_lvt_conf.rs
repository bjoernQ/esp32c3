...
pub struct COMB_PATH_LEN_LVT_R(crate::FieldReader<u8, u8>);
impl COMB_PATH_LEN_LVT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        COMB_PATH_LEN_LVT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COMB_PATH_LEN_LVT_R {
...
pub struct COMB_PATH_LEN_LVT_W<'a> {
    w: &'a mut W,
}
impl<'a> COMB_PATH_LEN_LVT_W<'a> {
...
pub struct COMB_ERR_CNT_CLR_LVT_W<'a> {
    w: &'a mut W,
}
impl<'a> COMB_ERR_CNT_CLR_LVT_W<'a> {
...
pub struct COMB_PVT_MONITOR_EN_LVT_R(crate::FieldReader<bool, bool>);
impl COMB_PVT_MONITOR_EN_LVT_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        COMB_PVT_MONITOR_EN_LVT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COMB_PVT_MONITOR_EN_LVT_R {
...
pub struct COMB_PVT_MONITOR_EN_LVT_W<'a> {
    w: &'a mut W,
}
impl<'a> COMB_PVT_MONITOR_EN_LVT_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
