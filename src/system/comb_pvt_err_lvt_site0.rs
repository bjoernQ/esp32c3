...
pub struct COMB_TIMING_ERR_CNT_LVT_SITE0_R(crate::FieldReader<u16, u16>);
impl COMB_TIMING_ERR_CNT_LVT_SITE0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        COMB_TIMING_ERR_CNT_LVT_SITE0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COMB_TIMING_ERR_CNT_LVT_SITE0_R {
