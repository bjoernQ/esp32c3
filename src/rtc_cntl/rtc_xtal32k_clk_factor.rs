...
impl R {
    ...
    pub fn xtal32k_clk_factor(&self) -> XTAL32K_CLK_FACTOR_R {
        XTAL32K_CLK_FACTOR_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - xtal 32k watch dog backup clock factor"]
...
#[doc = "rtc configure register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_xtal32k_clk_factor](index.html) module"]
pub struct RTC_XTAL32K_CLK_FACTOR_SPEC;
impl crate::RegisterSpec for RTC_XTAL32K_CLK_FACTOR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_xtal32k_clk_factor::R](R) reader structure"]
impl crate::Readable for RTC_XTAL32K_CLK_FACTOR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_xtal32k_clk_factor::W](W) writer structure"]
