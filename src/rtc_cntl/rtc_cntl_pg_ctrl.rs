...
#[doc = "rtc configure register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_cntl_pg_ctrl](index.html) module"]
pub struct RTC_CNTL_PG_CTRL_SPEC;
impl crate::RegisterSpec for RTC_CNTL_PG_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_cntl_pg_ctrl::R](R) reader structure"]
impl crate::Readable for RTC_CNTL_PG_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_cntl_pg_ctrl::W](W) writer structure"]
