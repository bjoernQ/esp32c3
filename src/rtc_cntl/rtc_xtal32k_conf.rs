#[doc = "Register `RTC_XTAL32K_CONF` reader"]
pub struct R(crate::R<RTC_XTAL32K_CONF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_XTAL32K_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_XTAL32K_CONF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_XTAL32K_CONF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_XTAL32K_CONF` writer"]
pub struct W(crate::W<RTC_XTAL32K_CONF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_XTAL32K_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_XTAL32K_CONF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_XTAL32K_CONF_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `XTAL32K_RETURN_WAIT` reader - cycles to wait to return noral xtal 32k"]
pub struct XTAL32K_RETURN_WAIT_R(crate::FieldReader<u8, u8>);
...
#[doc = "rtc configure register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_xtal32k_conf](index.html) module"]
pub struct RTC_XTAL32K_CONF_SPEC;
impl crate::RegisterSpec for RTC_XTAL32K_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_xtal32k_conf::R](R) reader structure"]
impl crate::Readable for RTC_XTAL32K_CONF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_xtal32k_conf::W](W) writer structure"]
impl crate::Writable for RTC_XTAL32K_CONF_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_XTAL32K_CONF to value 0x0ff0_0000"]
impl crate::Resettable for RTC_XTAL32K_CONF_SPEC {
    #[inline(always)]
