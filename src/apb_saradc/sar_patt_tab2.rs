...
pub struct SARADC_SAR_PATT_TAB2_R(crate::FieldReader<u32, u32>);
impl SARADC_SAR_PATT_TAB2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SARADC_SAR_PATT_TAB2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SARADC_SAR_PATT_TAB2_R {
...
pub struct SARADC_SAR_PATT_TAB2_W<'a> {
    w: &'a mut W,
}
impl<'a> SARADC_SAR_PATT_TAB2_W<'a> {
