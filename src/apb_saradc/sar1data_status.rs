...
pub struct APB_SARADC1_DATA_R(crate::FieldReader<u32, u32>);
impl APB_SARADC1_DATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        APB_SARADC1_DATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APB_SARADC1_DATA_R {
