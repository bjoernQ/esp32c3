...
pub struct SARADC_SAR2_STATUS_R(crate::FieldReader<u32, u32>);
impl SARADC_SAR2_STATUS_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SARADC_SAR2_STATUS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SARADC_SAR2_STATUS_R {
...
impl R {
    ...
    pub fn saradc_sar2_status(&self) -> SARADC_SAR2_STATUS_R {
        SARADC_SAR2_STATUS_R::new(self.bits as u32)
    }
}
