...
impl CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_0_R {
    ...
    pub(crate) fn new(bits: u8) -> Self {
        CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_0_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_0_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_0_W<'a> {
...
impl CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_1_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_1_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_1_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_2_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_2_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_2_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl CORE_X_IRAM0_SRAM_LINE_1_SPLITADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CORE_X_IRAM0_SRAM_LINE_1_SPLITADDR_R(crate::FieldReader::new(bits))
    }
}
...
pub struct CORE_X_IRAM0_SRAM_LINE_1_SPLITADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_X_IRAM0_SRAM_LINE_1_SPLITADDR_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    pub fn core_x_iram0_sram_line_1_category_0(&self) -> CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_0_R {
        CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_0_R::new((self.bits & 0x03) as u8)
    }
    ...
    pub fn core_x_iram0_sram_line_1_category_1(&self) -> CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_1_R {
        CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_1_R::new(((self.bits >> 2) & 0x03) as u8)
    }
    ...
    pub fn core_x_iram0_sram_line_1_category_2(&self) -> CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_2_R {
        CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_2_R::new(((self.bits >> 4) & 0x03) as u8)
    }
...
impl W {
    #[doc = "Bits 0:1 - core_x_iram0_sram_line_1_category_0"]
    #[inline(always)]
    pub fn core_x_iram0_sram_line_1_category_0(&mut self) -> CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_0_W {
        CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_0_W { w: self }
    }
    #[doc = "Bits 2:3 - core_x_iram0_sram_line_1_category_1"]
    #[inline(always)]
    pub fn core_x_iram0_sram_line_1_category_1(&mut self) -> CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_1_W {
        CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_1_W { w: self }
    }
    #[doc = "Bits 4:5 - core_x_iram0_sram_line_1_category_2"]
    #[inline(always)]
    pub fn core_x_iram0_sram_line_1_category_2(&mut self) -> CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_2_W {
        CORE_X_IRAM0_SRAM_LINE_1_CATEGORY_2_W { w: self }
    }
    #[doc = "Bits 14:21 - core_x_iram0_sram_line_1_splitaddr"]
    #[inline(always)]
    pub fn core_x_iram0_sram_line_1_splitaddr(&mut self) -> CORE_X_IRAM0_SRAM_LINE_1_SPLITADDR_W {
        CORE_X_IRAM0_SRAM_LINE_1_SPLITADDR_W { w: self }
    }
