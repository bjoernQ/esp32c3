...
impl DMA_APBPERI_LC_PMS_CONSTRAIN_LOCK_R {
    ...
    pub(crate) fn new(bits: bool) -> Self {
        DMA_APBPERI_LC_PMS_CONSTRAIN_LOCK_R(crate::FieldReader::new(bits))
    }
}
...
pub struct DMA_APBPERI_LC_PMS_CONSTRAIN_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> DMA_APBPERI_LC_PMS_CONSTRAIN_LOCK_W<'a> {
...
impl R {
    ...
    pub fn dma_apbperi_lc_pms_constrain_lock(&self) -> DMA_APBPERI_LC_PMS_CONSTRAIN_LOCK_R {
        DMA_APBPERI_LC_PMS_CONSTRAIN_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - dma_apbperi_lc_pms_constrain_lock"]
    #[inline(always)]
    pub fn dma_apbperi_lc_pms_constrain_lock(&mut self) -> DMA_APBPERI_LC_PMS_CONSTRAIN_LOCK_W {
        DMA_APBPERI_LC_PMS_CONSTRAIN_LOCK_W { w: self }
    }
