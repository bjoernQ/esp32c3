...
pub struct CORE_0_PIF_PMS_CONSTRAIN_LOCK_R(crate::FieldReader<bool, bool>);
impl CORE_0_PIF_PMS_CONSTRAIN_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_PIF_PMS_CONSTRAIN_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_CONSTRAIN_LOCK_R {
...
pub struct CORE_0_PIF_PMS_CONSTRAIN_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_PIF_PMS_CONSTRAIN_LOCK_W<'a> {
...
impl R {
    ...
    pub fn core_0_pif_pms_constrain_lock(&self) -> CORE_0_PIF_PMS_CONSTRAIN_LOCK_R {
        CORE_0_PIF_PMS_CONSTRAIN_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - core_0_pif_pms_constrain_lock"]
    #[inline(always)]
    pub fn core_0_pif_pms_constrain_lock(&mut self) -> CORE_0_PIF_PMS_CONSTRAIN_LOCK_W {
        CORE_0_PIF_PMS_CONSTRAIN_LOCK_W { w: self }
    }
