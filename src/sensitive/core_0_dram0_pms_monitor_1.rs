...
pub struct CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_R(crate::FieldReader<bool, bool>);
impl CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_R {
...
pub struct CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_W<'a> {
...
pub struct CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_R(crate::FieldReader<bool, bool>);
impl CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn core_0_dram0_pms_monitor_violate_clr(&self) -> CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_R {
        CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn core_0_dram0_pms_monitor_violate_en(&self) -> CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_R {
        CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_R::new(((self.bits >> 1) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - core_0_dram0_pms_monitor_violate_clr"]
    ...
    pub fn core_0_dram0_pms_monitor_violate_clr(
        &mut self,
    ) -> CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_W {
        CORE_0_DRAM0_PMS_MONITOR_VIOLATE_CLR_W { w: self }
    }
    #[doc = "Bit 1 - core_0_dram0_pms_monitor_violate_en"]
    #[inline(always)]
    pub fn core_0_dram0_pms_monitor_violate_en(&mut self) -> CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_W {
        CORE_0_DRAM0_PMS_MONITOR_VIOLATE_EN_W { w: self }
    }
