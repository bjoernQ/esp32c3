...
pub struct CORE_X_DRAM0_DMA_SRAM_LINE_1_CATEGORY_0_R(crate::FieldReader<u8, u8>);
...
pub struct CORE_X_DRAM0_DMA_SRAM_LINE_1_CATEGORY_1_R(crate::FieldReader<u8, u8>);
...
pub struct CORE_X_DRAM0_DMA_SRAM_LINE_1_CATEGORY_2_R(crate::FieldReader<u8, u8>);
...
pub struct CORE_X_DRAM0_DMA_SRAM_LINE_1_SPLITADDR_R(crate::FieldReader<u8, u8>);
...
impl R {
    ...
    pub fn core_x_dram0_dma_sram_line_1_category_0(
        ...
        CORE_X_DRAM0_DMA_SRAM_LINE_1_CATEGORY_0_R::new((self.bits & 0x03) as u8)
    }
    ...
    pub fn core_x_dram0_dma_sram_line_1_category_1(
        ...
        CORE_X_DRAM0_DMA_SRAM_LINE_1_CATEGORY_1_R::new(((self.bits >> 2) & 0x03) as u8)
    }
    ...
    pub fn core_x_dram0_dma_sram_line_1_category_2(
        ...
        CORE_X_DRAM0_DMA_SRAM_LINE_1_CATEGORY_2_R::new(((self.bits >> 4) & 0x03) as u8)
    }
