...
pub struct CACHE_TAG_ACCESS_LOCK_R(crate::FieldReader<bool, bool>);
impl CACHE_TAG_ACCESS_LOCK_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CACHE_TAG_ACCESS_LOCK_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CACHE_TAG_ACCESS_LOCK_R {
...
pub struct CACHE_TAG_ACCESS_LOCK_W<'a> {
    w: &'a mut W,
}
impl<'a> CACHE_TAG_ACCESS_LOCK_W<'a> {
...
impl R {
    ...
    pub fn cache_tag_access_lock(&self) -> CACHE_TAG_ACCESS_LOCK_R {
        CACHE_TAG_ACCESS_LOCK_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - cache_tag_access_lock"]
    ...
    pub fn cache_tag_access_lock(&mut self) -> CACHE_TAG_ACCESS_LOCK_W {
        CACHE_TAG_ACCESS_LOCK_W { w: self }
    }
