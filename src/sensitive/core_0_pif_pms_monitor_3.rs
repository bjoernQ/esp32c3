...
pub struct CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HADDR_R(crate::FieldReader<u32, u32>);
impl CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HADDR_R {
...
impl R {
    ...
    pub fn core_0_pif_pms_monitor_violate_status_haddr(
        ...
        CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HADDR_R::new(self.bits as u32)
    }
}
