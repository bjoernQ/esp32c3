...
pub struct RX_DONE_INT_RAW_R(crate::FieldReader<bool, bool>);
impl RX_DONE_INT_RAW_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        RX_DONE_INT_RAW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX_DONE_INT_RAW_R {
